...
describe('RDFNavigator Live Integration', () => {
  ...
  it('should extract words from live Wikipedia URL for Heart', async () => {
    const url = 'https://en.wikipedia.org/wiki/Medley_swimming';
  ...
  it('should parse live RDF and extract one layer of words for Heart', async () => {
    const rdfUrl = 'https://dbpedia.org/data/Medley_swimming.ttl';
    const subjectUri = 'http://dbpedia.org/resource/Medley_swimming';
    ...
    expect(layerMap.label).toContain('swimming');
  }, TIMEOUT);
